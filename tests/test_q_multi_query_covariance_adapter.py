...
from q_attention.plugins import MultiQueryCovarianceConfig, QuantumMultiQueryCovarianceKernel
...
def test_zero_gain_adapter_is_exactly_baseline_equivalent() -> None:
    ...
    kernel = QuantumMultiQueryCovarianceKernel(
    ...
    adapter = AttentionScoreKernelAdapter(steered_model, steered_model.score_module_paths, kernel)
