...
CONFIG_PATH=configs/retacred_qceasc_counterfactual_formal_single_seed.json
EXPERIMENT_NAME=retacred_qceasc_counterfactual_formal_single_seed
CHECK_SCRIPT=scripts/check_retacred_qceasc_counterfactual_formal_single_seed.py
EXPORT_SCRIPT=scripts/export_retacred_qceasc_counterfactual_formal_single_seed_report.sh
GPU_SPEC=auto
OUTPUT_DIR=
RESUME_DIR=
...
COMMAND=(
  "${PYTHON_BIN}" experiments/run_retacred_qceasc_formal_single_seed.py
  --config "${CONFIG_PATH}"
  --device cuda
  --seed 13
