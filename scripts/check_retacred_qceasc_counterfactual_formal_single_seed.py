...
RUNNER_NAME = "run_retacred_qceasc_formal_single_seed.py"
DEFAULT_CONFIG_NAME = "retacred_qceasc_counterfactual_formal_single_seed.json"
SUPPORTED_SCHEMA = "q-attention.q-ceasc-counterfactual-formal-single-seed.v1"
EXPECTED_SELECTORS = ["disabled", "q_ceasc_counterfactual", "classical_counterfactual"]
...
def main() -> int:
    ...
    if args.fresh:
        ...
        if config is None:
            ...
            errors.append("config has an unsupported Q-CEASC counterfactual schema")
        elif config.get("selectors") != EXPECTED_SELECTORS:
            errors.append("config selectors must be disabled, counterfactual Q-CEASC candidate, and matched control")
        ...
        if args.json:
            ...
            print("Q-CEASC counterfactual fresh-run preflight (READ ONLY)")
